/*
 * File: IAS-DataModelLib/src/dm/DataObjectList.h
 * 
...
public:
	...
	virtual void        set(int iIdx, DataObject* pDataObject) = 0;

	virtual void  clear() =0;

	virtual DataObject* operator [](int iIdx) = 0;
	virtual const DataObject* operator [](int iIdx) const = 0;
