/*
 * File: IAS-LangLib/src/lang/interpreter/text/ExternalProgramNodeHandler.h
 * 
 ...
 */
#ifndef _IAS_AS_Lang_Export_Text_ExternalProgramNodeHandler_H_
#define _IAS_AS_Lang_Export_Text_ExternalProgramNodeHandler_H_
