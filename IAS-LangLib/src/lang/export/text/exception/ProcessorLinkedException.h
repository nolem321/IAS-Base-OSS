/*
 * File: IAS-LangLib/src/lang/interpreter/text/exception/ProcessorLinkedException.h
 * 
...
#ifndef _IAS_AS_Lang_Export_Text_Exception_ProcessorLinkedException_H_
#define _IAS_AS_Lang_Export_Text_Exception_ProcessorLinkedException_H_
