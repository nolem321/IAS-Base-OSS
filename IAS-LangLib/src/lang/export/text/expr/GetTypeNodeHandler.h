/*
 * File: IAS-LangLib/src/lang/export/text/expr/GetTypeNodeHandler.h
 * 
 ...
 */
#ifndef _IAS_AS_Lang_Export_Text_Expr_GetTypeNodeHandler_H_
#define _IAS_AS_Lang_Export_Text_Expr_GetTypeNodeHandler_H_
