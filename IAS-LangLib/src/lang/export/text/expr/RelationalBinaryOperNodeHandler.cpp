/*
 * File: IAS-LangLib/src/lang/export/text/expr/RelationalBinaryOperNodeHandler.cpp
 * 
...
void RelationalBinaryOperNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, CallbackSignature::Result& aResult){
	...
	handleBinary(pRelationalBinaryOperNode->getLeftExpr(),pRelationalBinaryOperNode->getRightExpr(),pCtx,aResult," ??? ");
}
/*************************************************************************/
}
}
