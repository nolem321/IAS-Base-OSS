/*
 * File: IAS-LangLib/src/lang/export/text/expr/RelationalIsTypeNodeHandler.h
 * 
 ...
 */
#ifndef _IAS_AS_Lang_Export_Text_Expr_RelationalIsTypeNodeHandler_H_
#define _IAS_AS_Lang_Export_Text_Expr_RelationalIsTypeNodeHandler_H_
