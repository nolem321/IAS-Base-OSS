/*
 * File: IAS-LangLib/src/lang/interpreter/text/expr/xpath/XPathVariableAccessNodeHandler.h
 * 
 ...
 */
#ifndef _IAS_AS_Lang_Export_Text_Expr_XPathVariableAccessNodeHandler_H_
#define _IAS_AS_Lang_Export_Text_Expr_XPathVariableAccessNodeHandler_H_
