/*
 * File: IAS-LangLib/src/lang/export/text/stmt/CreateNodeHandler.cpp
 * 
...
void CreateNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, CallbackSignature::Result& aResult){
	...
	printKeyword(aResult,"CREATE");
	CallbackRegister::SubCall(pCreateNode->getXPathAccessNode(),pCtx,aResult);

	if(pCreateNode->hasStatement()){
		CallbackRegister::SubCall(pCreateNode->getStatementNode(),pCtx,aResult);
	}
}
/*************************************************************************/
}
