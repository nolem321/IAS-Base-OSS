/*
 * File: IAS-LangLib/src/lang/export/text/stmt/DeleteNodeHandler.h
 * 
 ...
 */
#ifndef _IAS_AS_Lang_Export_Text_Stmt_DeleteNodeHandler_H_
#define _IAS_AS_Lang_Export_Text_Stmt_DeleteNodeHandler_H_
