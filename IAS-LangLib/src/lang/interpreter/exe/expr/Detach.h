/*
 * File: IAS-LangLib/src/lang/interpreter/exe/stmt/Detach.h
 * 
 ...
 */
#ifndef _IAS_Lang_Interpreter_Exe_Expr_Detach_H_
#define _IAS_Lang_Interpreter_Exe_Expr_Detach_H_
 ...
 *
 */
class Detach : public DataObjectExpr {
public:

	virtual ~Detach() throw();
...
protected:
	...
	Detach(XPath::XPathExprFamily   *pXPathExprFamily);
	IAS_DFT_FACTORY<XPath::XPathExprFamily>::PtrHolder   ptrXPathExprFamily;

	friend class ::IAS::Factory<Detach>;
};
...
#endif /* _IAS_Lang_Interpreter_Exe_Stmt_Detach_H_ */
