...
/*************************************************************************/
ReadCertificate::ReadCertificate(const StringList& lstParamaters, const ModuleProxy* pModuleProxy){
	IAS_TRACER;
...
/*************************************************************************/
Statement* ReadCertificate::Create(const StringList& lstParamaters, const ModuleProxy* pModuleProxy){
	IAS_TRACER;
	return IAS_DFT_FACTORY<ReadCertificate>::Create(lstParamaters, pModuleProxy);
}
/*************************************************************************/
}
}
