...
/*************************************************************************/
GetRandom::GetRandom(const DM::Type* pType, const StringList& lstParamaters, const ModuleProxy* pModuleProxy){
	IAS_TRACER;
...
/*************************************************************************/
Statement* GetRandom::Create(const DM::Type* pType, const StringList& lstParamaters, const ModuleProxy* pModuleProxy){
	IAS_TRACER;
	return IAS_DFT_FACTORY<GetRandom>::Create(pType, lstParamaters, pModuleProxy);
}
/*************************************************************************/
}
}
