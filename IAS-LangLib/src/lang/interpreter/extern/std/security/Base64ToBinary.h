 ...
 */
#ifndef _IAS_Lang_Interpreter_Extern_Std_Security_Base64ToBinary_H_
#define _IAS_Lang_Interpreter_Extern_Std_Security_Base64ToBinary_H_
...
protected:
	...
	Base64ToBinary(const DM::Type* pType, const StringList& lstParamaters, const ModuleProxy* pModuleProxy);
