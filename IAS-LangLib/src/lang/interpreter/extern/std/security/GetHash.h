 ...
 */
#ifndef _IAS_Lang_Interpreter_Extern_Std_Security_GetHash_H_
#define _IAS_Lang_Interpreter_Extern_Std_Security_GetHash_H_
...
#endif /* _IAS_Lang_Interpreter_Extern_Std_Security_GetHash_H_ */
