 ...
 */
#ifndef _IAS_Lang_Interpreter_Extern_Std_Security_StandardModuleProxy_H_
#define _IAS_Lang_Interpreter_Extern_Std_Security_StandardModuleProxy_H_
...
#endif /* _IAS_Lang_Interpreter_Extern_Std_Security_StandardModuleProxy_H_ */
