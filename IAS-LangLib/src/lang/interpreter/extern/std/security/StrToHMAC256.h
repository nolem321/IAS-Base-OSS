 ...
 */
#ifndef _IAS_Lang_Interpreter_Extern_Std_Security_StrToHMAC256_H_
#define _IAS_Lang_Interpreter_Extern_Std_Security_StrToHMAC256_H_
...
protected:
	...
	StrToHMAC256(const DM::Type* pType, const StringList& lstParamaters, const ModuleProxy* pModuleProxy);
