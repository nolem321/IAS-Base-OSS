 ...
 */
#ifndef _IAS_Lang_Interpreter_Extern_Std_Security_StrToSHA256_H_
#define _IAS_Lang_Interpreter_Extern_Std_Security_StrToSHA256_H_
...
protected:
	...
	StrToSHA256(const DM::Type* pType, const StringList& lstParamaters, const ModuleProxy* pModuleProxy);
