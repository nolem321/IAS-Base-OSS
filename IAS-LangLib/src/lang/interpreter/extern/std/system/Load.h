 ...
 */
#ifndef _IAS_Lang_Interpreter_Extern_Std_System_Load_H_
#define _IAS_Lang_Interpreter_Extern_Std_System_Load_H_
...
#endif /* _IAS_Lang_Interpreter_Extern_Std_System_Load_H_ */
