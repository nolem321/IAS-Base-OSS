/*
 * File: IAS-LangLib/src/lang/interpreter/proc/expr/GetTypeNSNodeHandler.h
 * 
 ...
 */
#ifndef _IAS_AS_Lang_Interpreter_Proc_Expr_GetTypeNSNodeHandler_H_
#define _IAS_AS_Lang_Interpreter_Proc_Expr_GetTypeNSNodeHandler_H_
