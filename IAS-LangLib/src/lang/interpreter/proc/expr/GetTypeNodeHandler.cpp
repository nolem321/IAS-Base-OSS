/*
 * File: IAS-LangLib/src/lang/interpreter/proc/expr/GetTypeNodeHandler.cpp
 * 
...
#include <lang/interpreter/exe/expr/GetTypeExpr.h>
...
void GetTypeNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, CallbackSignature::Result& aResult){
	...
	aResult.pExpr=IAS_DFT_FACTORY<Exe::Expr::GetTypeExpr>::Create(pCtx->getDataFactory(),ptrExpr.pass());
