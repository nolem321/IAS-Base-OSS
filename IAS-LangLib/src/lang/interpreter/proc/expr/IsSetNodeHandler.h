/*
 * File: IAS-LangLib/src/lang/interpreter/proc/expr/IsSetNodeHandler.h
 * 
 ...
 */
#ifndef _IAS_AS_Lang_Interpreter_Proc_Expr_IsSetNodeHandler_H_
#define _IAS_AS_Lang_Interpreter_Proc_Expr_IsSetNodeHandler_H_
