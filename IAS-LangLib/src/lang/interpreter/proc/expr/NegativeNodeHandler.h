/*
 * File: IAS-LangLib/src/lang/interpreter/proc/expr/NegativeNodeHandler.h
 * 
 ...
 */
#ifndef _IAS_AS_Lang_Interpreter_Proc_Expr_NegativeNodeHandler_H_
#define _IAS_AS_Lang_Interpreter_Proc_Expr_NegativeNodeHandler_H_
