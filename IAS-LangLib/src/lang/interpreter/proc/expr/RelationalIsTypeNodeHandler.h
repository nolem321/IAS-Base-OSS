/*
 * File: IAS-LangLib/src/lang/interpreter/proc/expr/RelationalIsTypeNodeHandler.h
 * 
 ...
 */
#ifndef _IAS_AS_Lang_Interpreter_Proc_Expr_RelationalIsTypeNodeHandler_H_
#define _IAS_AS_Lang_Interpreter_Proc_Expr_RelationalIsTypeNodeHandler_H_
