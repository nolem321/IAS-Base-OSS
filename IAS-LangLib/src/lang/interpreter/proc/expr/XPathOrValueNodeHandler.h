/*
 * File: IAS-LangLib/src/lang/interpreter/proc/expr/XPathOrValueNodeHandler.h
 * 
 ...
 */
#ifndef _IAS_AS_Lang_Interpreter_Proc_Expr_XPathOrValueNodeHandler_H_
#define _IAS_AS_Lang_Interpreter_Proc_Expr_XPathOrValueNodeHandler_H_
