/*
 * File: IAS-LangLib/src/lang/interpreter/proc/expr/xpath/XPathExprAccessNodeHandler.h
 * 
 ...
 */
#ifndef _IAS_AS_Lang_Interpreter_Proc_Expr_XPathExprAccessNodeHandler_H_
#define _IAS_AS_Lang_Interpreter_Proc_Expr_XPathExprAccessNodeHandler_H_
