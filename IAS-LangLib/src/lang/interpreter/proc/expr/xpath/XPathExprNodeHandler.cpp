/*
 * File: IAS-LangLib/src/lang/interpreter/proc/expr/xpath/XPathExprNodeHandler.cpp
 * 
...
void XPathExprNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, CallbackSignature::Result& aResult){
	...
	CallbackRegister::SubCall(pXPathExprNode->getXPathAccessNode(),pCtx,aResultTmp);
	aResult.pExpr=aResultTmp.pXPathExprFamily;
}
/*************************************************************************/
}
}
