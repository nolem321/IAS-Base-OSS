/*
 * File: IAS-LangLib/src/lang/interpreter/proc/stmt/CreateNodeHandler.h
 * 
 ...
 */
#ifndef _IAS_AS_Lang_Interpreter_Proc_Stmt_CreateNodeHandler_H_
#define _IAS_AS_Lang_Interpreter_Proc_Stmt_CreateNodeHandler_H_
