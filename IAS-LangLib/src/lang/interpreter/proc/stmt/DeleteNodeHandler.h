/*
 * File: IAS-LangLib/src/lang/interpreter/proc/stmt/DeleteNodeHandler.h
 * 
 ...
 */
#ifndef _IAS_AS_Lang_Interpreter_Proc_Stmt_DeleteNodeHandler_H_
#define _IAS_AS_Lang_Interpreter_Proc_Stmt_DeleteNodeHandler_H_
