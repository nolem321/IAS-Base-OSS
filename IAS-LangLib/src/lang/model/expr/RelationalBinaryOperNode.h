/*
 * File: IAS-LangLib/src/lang/model/expr/RelationalBinaryOperNode.h
 * 
 ...
 */
#ifndef _IAS_AS_Lang_Model_Expr_RelationalBinaryOPERNODE_H_
#define _IAS_AS_Lang_Model_Expr_RelationalBinaryOPERNODE_H_
