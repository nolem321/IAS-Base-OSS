/*
 * File: IAS-LangLib/src/lang/model/stmt/ConditionalAssignmentNode.cpp
 * 
 ...
 */
#include "ConditionalAssignmentNode.h"
...
/*************************************************************************/
ConditionalAssignmentNode::ConditionalAssignmentNode(LeftSideNode   *pLeftSideNode,
...
/*************************************************************************/
ConditionalAssignmentNode::~ConditionalAssignmentNode() throw(){
	IAS_TRACER;
}
/*************************************************************************/
}
