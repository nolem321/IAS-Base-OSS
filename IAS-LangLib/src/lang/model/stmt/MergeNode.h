/*
 * File: IAS-LangLib/src/lang/model/stmt/MergeNode.h
 * 
 ...
 */
#ifndef _IAS_AS_Lang_Model_Stmt_MergeNode_H_
#define _IAS_AS_Lang_Model_Stmt_MergeNode_H_
...
/*************************************************************************/
/** The class. */
 class MergeNode : public StatementNode {
public:

	virtual ~MergeNode() throw();
...
protected:
	MergeNode(LeftSideNode   *pLeftSideNode,
	...
	friend class ::IAS::Factory<MergeNode>;
};
