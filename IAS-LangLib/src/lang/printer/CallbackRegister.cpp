...
/*************************************************************************/
void CallbackRegister::Call(const Model::Node* pNode, std::ostream& os){
	IAS_TRACER;

	CallbackSignature::CallbackCtx  ctx;
	GetInstance()->getCallback(pNode)->call(pNode, &ctx, os);
}
/*************************************************************************/
void CallbackRegister::SubCall(const Model::Node* pNode, CallbackSignature::CallbackCtx* pCtx, std::ostream& os){
	IAS_TRACER;
	GetInstance()->getCallback(pNode)->call(pNode, pCtx, os);
}
/*************************************************************************/
}
}
