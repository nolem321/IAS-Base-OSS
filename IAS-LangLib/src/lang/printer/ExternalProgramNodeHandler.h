/*
 * File: IAS-LangLib/src/lang/printer/ExternalProgramNodeHandler.h
 * 
 ...
 */
#ifndef _IAS_AS_Lang_Printer_ExternalProgramNodeHandler_H_
#define _IAS_AS_Lang_Printer_ExternalProgramNodeHandler_H_
