/*
 * File: IAS-LangLib/src/lang/export/text/dec/ResultDeclarationNodeHandler.cpp
 *
...
/*************************************************************************/
void ResultDeclarationNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, std::ostream& os){
	IAS_TRACER;
	...
	printIndent(pCtx,os);
	os<<"VAR ";
	os<<pDeclarationNode->getVariable();
	os<<" AS ";
	if(pDeclarationNode->isArray())
		os<<"ARRAY OF ";
