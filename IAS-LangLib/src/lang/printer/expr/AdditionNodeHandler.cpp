/*
 * File: IAS-LangLib/src/lang/printer/expr/AdditionNodeHandler.cpp
 * 
...
/*************************************************************************/
void AdditionNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, std::ostream& os){
	IAS_TRACER;
	...
	handleBinary(pAdditionNode->getLeftExpr(),pAdditionNode->getRightExpr(),pCtx,os," + ");
}
/*************************************************************************/
}
}
