/*
 * File: IAS-LangLib/src/lang/printer/expr/CastNodeHandler.cpp
 * 
...
/*************************************************************************/
void CastNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, std::ostream& os){
	IAS_TRACER;
	...
	os<<" ( ";
	CallbackRegister::SubCall(pCastNode->getChild(),pCtx,os);
	os<<" AS ";
