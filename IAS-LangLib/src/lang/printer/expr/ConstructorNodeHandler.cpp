/*
 * File: IAS-LangLib/src/lang/printer/expr/ConstructorNodeHandler.cpp
 * 
...
/*************************************************************************/
void ConstructorNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, std::ostream& os){
	IAS_TRACER;
	...
	os<<"NEW ";
	os<<pConstructorNode->getTypeName();
	os<<" : \"";
	os<<pConstructorNode->getTypeURI();
	os<<"\"";

	if(pConstructorNode->hasStatement()){
		os<<" ";
		CallbackRegister::SubCall(pConstructorNode->getStatementNode(),pCtx,os);
	}
}
/*************************************************************************/
}
