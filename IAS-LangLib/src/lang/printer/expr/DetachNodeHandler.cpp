/*
 * File: IAS-LangLib/src/lang/printer/expr/DetachNodeHandler.cpp
 * 
...
/*************************************************************************/
void DetachNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, std::ostream& os){
	IAS_TRACER;
	...
	os<<"DETACH(";
	CallbackRegister::SubCall(pDetachNode->getXPathAccessNode(),pCtx,os);
	os<<")";
