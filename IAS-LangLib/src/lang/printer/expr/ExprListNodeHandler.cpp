/*
 * File: IAS-LangLib/src/lang/printer/expr/ExprListNodeHandler.cpp
 * 
...
/*************************************************************************/
void ExprListNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, std::ostream& os){
	IAS_TRACER;
	...
	for(Model::Expr::ExprListNode::ExprNodeList::const_iterator it = lstExprNodes.begin();
		...
		CallbackRegister::SubCall(*it,pCtx,os);
	}
