/*
 * File: IAS-LangLib/src/lang/printer/expr/GetTypeNSNodeHandler.cpp
 * 
...
/*************************************************************************/
void GetTypeNSNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, std::ostream& os){
	IAS_TRACER;
	...
	os<<"TYPENS(";
	CallbackRegister::SubCall(pGetTypeNSNode->getChild(),pCtx,os);
	os<<")";
