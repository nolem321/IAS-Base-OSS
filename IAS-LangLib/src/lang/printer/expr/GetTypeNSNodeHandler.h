/*
 * File: IAS-LangLib/src/lang/printer/expr/GetTypeNSNodeHandler.h
 * 
 ...
 */
#ifndef _IAS_AS_Lang_Printer_Expr_GetTypeNSNodeHandler_H_
#define _IAS_AS_Lang_Printer_Expr_GetTypeNSNodeHandler_H_
