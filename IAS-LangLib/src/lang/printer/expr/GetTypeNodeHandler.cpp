/*
 * File: IAS-LangLib/src/lang/printer/expr/GetTypeNodeHandler.cpp
 * 
...
/*************************************************************************/
void GetTypeNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, std::ostream& os){
	IAS_TRACER;
	...
	os<<"TYPE(";
	CallbackRegister::SubCall(pGetTypeNode->getChild(),pCtx,os);
	os<<")";
