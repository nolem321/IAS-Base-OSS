/*
 * File: IAS-LangLib/src/lang/printer/expr/GetTypeNodeHandler.h
 * 
 ...
 */
#ifndef _IAS_AS_Lang_Printer_Expr_GetTypeNodeHandler_H_
#define _IAS_AS_Lang_Printer_Expr_GetTypeNodeHandler_H_
