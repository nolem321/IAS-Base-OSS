/*
 * File: IAS-LangLib/src/lang/printer/expr/IsSetNodeHandler.cpp
 * 
...
/*************************************************************************/
void IsSetNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, std::ostream& os){
	IAS_TRACER;
	...
	os<<" ISSET (";
	CallbackRegister::SubCall(pIsSetNode->getXPathAccessNode(),pCtx,os);
	os<<")";
