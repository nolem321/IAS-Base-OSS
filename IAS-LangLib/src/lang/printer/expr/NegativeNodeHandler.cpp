/*
 * File: IAS-LangLib/src/lang/printer/expr/NegativeNodeHandler.cpp
 * 
...
/*************************************************************************/
void NegativeNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, std::ostream& os){
	IAS_TRACER;
	...
	handleUnary(pNegativeNode->getChild(),pCtx,os,"-");
