/*
 * File: IAS-LangLib/src/lang/printer/expr/RelationalEqGtNodeHandler.cpp
 * 
...
/*************************************************************************/
void RelationalEqGtNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, std::ostream& os){
	IAS_TRACER;
	...
	handleBinary(pEqGtNode->getLeftExpr(),pEqGtNode->getRightExpr(),pCtx,os," >= ");
}
/*************************************************************************/
}
}
