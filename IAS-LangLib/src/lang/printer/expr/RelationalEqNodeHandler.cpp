/*
 * File: IAS-LangLib/src/lang/printer/expr/RelationalEqNodeHandler.cpp
 * 
...
/*************************************************************************/
void RelationalEqNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, std::ostream& os){
	IAS_TRACER;
	...
	handleBinary(pEqNode->getLeftExpr(),pEqNode->getRightExpr(),pCtx,os," == ");
}
/*************************************************************************/
}
}
