/*
 * File: IAS-LangLib/src/lang/printer/expr/RelationalGtNodeHandler.cpp
 * 
...
/*************************************************************************/
void RelationalGtNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, std::ostream& os){
	IAS_TRACER;
	...
	handleBinary(pGtNode->getLeftExpr(),pGtNode->getRightExpr(),pCtx,os," > ");
}
/*************************************************************************/
}
}
