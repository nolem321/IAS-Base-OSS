/*
 * File: IAS-LangLib/src/lang/printer/expr/RelationalLessNodeHandler.cpp
 * 
...
/*************************************************************************/
void RelationalLessNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, std::ostream& os){
	IAS_TRACER;
	...
	handleBinary(pLessNode->getLeftExpr(),pLessNode->getRightExpr(),pCtx,os," < ");
}
/*************************************************************************/
}
}
