/*
 * File: IAS-LangLib/src/lang/printer/expr/SubtractionNodeHandler.cpp
 * 
...
/*************************************************************************/
void SubtractionNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, std::ostream& os){
	IAS_TRACER;
	...
	handleBinary(pSubtractionNode->getLeftExpr(),pSubtractionNode->getRightExpr(),pCtx,os," - ");
}
/*************************************************************************/
}
}
