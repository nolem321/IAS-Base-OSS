/*
 * File: IAS-LangLib/src/lang/printer/expr/xpath/XPathExprNodeHandler.cpp
 * 
...
/*************************************************************************/
void XPathExprNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, std::ostream& os){
	IAS_TRACER;
	...
	CallbackRegister::SubCall(pXPathExprNode->getXPathAccessNode(),pCtx,os);
