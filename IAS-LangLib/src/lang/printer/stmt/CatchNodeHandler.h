/*
 * File: IAS-LangLib/src/lang/printer/stmt/CatchNodeHandler.h
 * 
 ...
 */
#ifndef _IAS_AS_Lang_Printer_Stmt_CatchNodeHandler_H_
#define _IAS_AS_Lang_Printer_Stmt_CatchNodeHandler_H_
