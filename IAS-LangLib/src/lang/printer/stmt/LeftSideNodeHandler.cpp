/*
 * File: IAS-LangLib/src/lang/printer/stmt/LeftSideNodeHandler.cpp
 * 
...
/*************************************************************************/
void LeftSideNodeHandler::call(const Model::Node* pNode, CallbackCtx *pCtx, std::ostream& os){
	IAS_TRACER;
	...
	CallbackRegister::SubCall(pLeftSideNode->getXPathAccessNode(),pCtx,os);
}
/*************************************************************************/
}
}
