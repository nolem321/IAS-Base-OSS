/*
 * File: IAS-LangLib/src/lang/printer/stmt/MergeNodeHandler.h
 * 
 ...
 */
#ifndef _IAS_AS_Lang_Printer_Stmt_MergeNodeHandler_H_
#define _IAS_AS_Lang_Printer_Stmt_MergeNodeHandler_H_
