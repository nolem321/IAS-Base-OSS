...
public:
	...
	void setSearchPath(const StringList& lstSourcePath, bool bReplace = false);
...
protected:
  ...
  static const String CDefaultLangDirectory;
  static const String CDefaultLangCurrentDir;
  static const String CEnv_SRC_DIRS;
};
