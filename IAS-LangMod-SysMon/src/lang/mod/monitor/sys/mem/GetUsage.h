/*
 * File: IAS-LangMod-SysMon/src/lang/mod/monitor/sys/mem/GetUsage.h
 * 
 ...
 */
#ifndef _IAS_Lang_MOD_Monitor_SYS_MEM_GetUsage_H_
#define _IAS_Lang_MOD_Monitor_SYS_MEM_GetUsage_H_
...
protected:
	GetUsage(const StringList& lstParamaters, const ::IAS::Lang::Interpreter::Extern::ModuleProxy* pModuleProxy);
...
#endif /* _IAS_Lang_MOD_Monitor_SYS_MEM_GetUsage_H_ */
