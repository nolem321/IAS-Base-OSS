/*
 * File: IAS-QSystemLib-TestCases/src/ias_qs_performance.cpp
 * 
...
#include "perfcases/Put.h"
#include "perfcases/Output.h"
#include "perfcases/DataObjects.h"
...
int main(int argc, char* argv[]) {
	...
	//IAS::LogLevel::INSTANCE.bIsStackTrace=false;
	...
	try {
		...
		//IAS_DFT_FACTORY<DataObjects>::Create(ptrSuite.getPointer());

		//if(0){
		//	IAS_DFT_FACTORY<Put>::Create(ptrSuite.getPointer());
			IAS_DFT_FACTORY<Output>::Create(ptrSuite.getPointer());
		//}
