/*
 * File: IAS-QSystemLib/src/qs/Impl/net/async/Receiver.h
 * 
 ...
 */
#ifndef _IAS_QS_Net_Async_Receiver_H_
#define _IAS_QS_Net_Async_Receiver_H_
...
#endif /* _IAS_QS_Net_Async_Receiver_H_ */
