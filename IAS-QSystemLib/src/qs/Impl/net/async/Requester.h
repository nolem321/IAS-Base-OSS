/*
 * File: IAS-QSystemLib/src/qs/Impl/net/async/Requester.h
 * 
 ...
 */
#ifndef _IAS_QS_Net_Async_Requester_H_
#define _IAS_QS_Net_Async_Requester_H_
...
protected:
	...
	const API::Destination aDestination;
