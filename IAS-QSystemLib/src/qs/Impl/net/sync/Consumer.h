/*
 * File: IAS-QSystemLib/src/qs/Impl/net/sync/Consumer.h
 * 
 ...
 */
#ifndef _IAS_QS_Net_Sync_Consumer_H_
#define _IAS_QS_Net_Sync_Consumer_H_
...
#endif /* _IAS_QS_Net_Sync_Consumer_H_ */
