/*
 * File: IAS-QSystemLib/src/qs/Impl/net/sync/Receiver.h
 * 
 ...
 */
#ifndef _IAS_QS_Net_Sync_Receiver_H_
#define _IAS_QS_Net_Sync_Receiver_H_
...
#endif /* _IAS_QS_Net_Sync_Receiver_H_ */
