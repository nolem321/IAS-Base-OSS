/*
 * File: IAS-QSystemLib/src/qs/Impl/net/sync/Responder.h
 * 
 ...
 */
#ifndef _IAS_QS_Net_Sync_Responder_H_
#define _IAS_QS_Net_Sync_Responder_H_
...
#endif /* _IAS_QS_Net_Sync_Responder_H_ */
