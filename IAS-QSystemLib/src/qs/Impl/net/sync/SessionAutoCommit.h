/*
 * File: IAS-QSystemLib/src/qs/Impl/net/sync/SessionAutoCommit.h
 * 
 ...
 */
#ifndef _IAS_QS_Net_Sync_SessionAutoCommit_H_
#define _IAS_QS_Net_Sync_SessionAutoCommit_H_
...
#endif /* _IAS_QS_Net_Sync_SessionAutoCommit_H_ */
