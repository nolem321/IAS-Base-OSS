/*
 * File: IAS-QSystemLib/src/qs/Impl/net/sync/SessionTransacted.h
 * 
 ...
 */
#ifndef _IAS_QS_Net_Sync_SessionTransacted_H_
#define _IAS_QS_Net_Sync_SessionTransacted_H_
...
#endif /* _IAS_QS_Net_Sync_SessionTransacted_H_ */
