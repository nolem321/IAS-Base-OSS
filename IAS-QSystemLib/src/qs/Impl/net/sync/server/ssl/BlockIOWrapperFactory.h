/*
 * File: IAS-QSystemLib/src/qs/Impl/net/sync/server/ssl/BlockIOWrapperFactory.h
 * 
 ...
 */
#ifndef _IAS_QS_Net_Sync_Server_SSL_BlockIOWrapperFactory_H_
#define _IAS_QS_Net_Sync_Server_SSL_BlockIOWrapperFactory_H_
...
class BlockIOWrapperFactory :
		public Server::BlockIOWrapperFactory {
public:
...
#endif /* _IAS_QS_Net_Sync_Server_SSL_BlockIOWrapperFactory_H_ */
