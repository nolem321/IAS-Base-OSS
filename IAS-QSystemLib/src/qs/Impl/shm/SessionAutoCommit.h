/*
 * File: IAS-QSystemLib/src/qs/Impl/shm/SessionAutoCommit.h
 * 
 ...
 */
#ifndef _IAS_QS_System_SessionAutoCommit_H_
#define _IAS_QS_System_SessionAutoCommit_H_
...
#endif /* _IAS_QS_System_SessionAutoCommit_H_ */
