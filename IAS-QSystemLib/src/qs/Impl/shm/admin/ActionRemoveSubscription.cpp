/*
 * File: IAS-QSystemLib/src/qs/Impl/shm/admin/ActionRemoveSubscription.cpp
 * 
...
/*************************************************************************/
ActionRemoveSubscription::ActionRemoveSubscription(){
	IAS_TRACER;
}

/*************************************************************************/
ActionRemoveSubscription::~ActionRemoveSubscription() throw(){
	IAS_TRACER;
}
/*************************************************************************/
void ActionRemoveSubscription::work(QS::SHM::Attachment *pAttachment, ::org::invenireaude::qsystem::Action* pAction){
	IAS_TRACER;

	const qsystem::Ext::ActionRemoveSubscriptionPtr dmCreateQueueAction(qsystem::DataFactory::GetInstance()->getActionRemoveSubscriptionType()->cast(pAction));
