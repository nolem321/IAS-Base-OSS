/*
 * File: IAS-QSystemLib/src/qs/fmt/StringFormatter.h
 * 
 ...
 */
#ifndef _IAS_QS_Fmt_StringFormatter_H_
#define _IAS_QS_Fmt_StringFormatter_H_
...
protected:
	StringFormatter(const DM::DataFactory* pDataFactory);
	...
	friend class Factory<StringFormatter>;
};
...
#endif /* _IAS_QS_Fmt_StringFormatter_H_ */
