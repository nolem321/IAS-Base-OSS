/*
 * File: IAS-QSystemLib/src/qs/lang/dict/SetValue.cpp
 * 
...
/*************************************************************************/
SetValue::~SetValue() throw(){
	IAS_TRACER;
}
/*************************************************************************/
void SetValue::executeExternal(Exe::Context *pCtx) const{
	IAS_TRACER;
	...
	try{
		...
		pWorkContext->getGlobalContext()->getDictionaryStore()->lookup(strDictName)->setValue(strItemKey,dmValue);
