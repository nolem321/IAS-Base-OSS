/*
 * File: IAS-QSystemLib/src/qs/lang/ec/ReadAll.h
 *
 ...
 */
#ifndef _IAS_QS_Lang_EC_ReadAll_H_
#define _IAS_QS_Lang_EC_ReadAll_H_
 ...
 *
 */
class ReadAll : public ::IAS::Lang::Interpreter::Extern::Statement {
public:
...
protected:
	...
	ReadAll(const DM::Type* pType, const StringList& lstParamaters, const ::IAS::Lang::Interpreter::Extern::ModuleProxy* pModuleProxy);
	...
	friend class ::IAS::Factory<ReadAll>;
};
...
#endif /* _IAS_Lang_Interpreter_Extern_Std_ReadAll_H_ */
