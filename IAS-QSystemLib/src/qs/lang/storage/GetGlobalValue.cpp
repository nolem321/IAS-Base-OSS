/*
 * File: IAS-QSystemLib/src/qs/lang/dict/GetGlobalValue.cpp
 *
...
/*************************************************************************/
GetGlobalValue::GetGlobalValue(const DM::Type* pType, const StringList& lstParamaters, const ::IAS::Lang::Interpreter::Extern::ModuleProxy* pModuleProxy){
	IAS_TRACER;
}
/*************************************************************************/
GetGlobalValue::~GetGlobalValue() throw(){
	IAS_TRACER;
}
/*************************************************************************/
void GetGlobalValue::executeExternal(Exe::Context *pCtx) const{
	IAS_TRACER;
	...
	try{
		...
		pParameters->setDataObject(String(IAS::Lang::Model::Dec::ResultDeclarationNode::CStrResultVariable),
						pWorkContext->storage.getGlobalValue(strKey));
...
/*************************************************************************/
Extern::Statement* GetGlobalValue::Create(const DM::Type* pType, const StringList& lstParamaters, const ::IAS::Lang::Interpreter::Extern::ModuleProxy* pModuleProxy){
	IAS_TRACER;
	return IAS_DFT_FACTORY<GetGlobalValue>::Create(pType, lstParamaters, pModuleProxy);
}
/*************************************************************************/
}
}
