/*
 * File: IAS-QSystemLib/src/qs/workers/proc/ds/wrapper/SelectCall.cpp
 * 
...
/*************************************************************************/
SelectCall::SelectCall(::IAS::DS::API::Session* pSession,
			   Lexer *pLexer,
...
/*************************************************************************/
SelectCall::~SelectCall() throw(){
	IAS_TRACER;
}
/*************************************************************************/
SelectCall::TypesMap::TypesMap()throw(){};
/*************************************************************************/
SelectCall::ResultSetSettersTableWithOffset::ResultSetSettersTableWithOffset(const DM::Type* pType):
		ResultSetSettersTable(pType),iOffset(0){};
/*************************************************************************/
void SelectCall::ResultSetSettersTableWithOffset::setOffset(int iOffset){
	this->iOffset=iOffset;
}
/*************************************************************************/
int SelectCall::ResultSetSettersTableWithOffset::getOffset()const{
	return iOffset;
}
/*************************************************************************/
SelectCall::ResultSetSettersTableWithOffset& SelectCall::TypesMap::add(const String& strKey, const DM::Type* pType) {
	IAS_TRACER;
	if(hmEntries.count(strKey))
		IAS_THROW(BadUsageException(strKey+" - already exist."));
	SelectCall::ResultSetSettersTableWithOffset *pResult = hmEntries[strKey]=EntryFactory::Create(pType);
	lstBindOrder.push_back(pResult);
	return *pResult;
}
/*************************************************************************/
void SelectCall::TypesMap::setDefault(const DM::Type* pType) {
	IAS_TRACER;
...
/*************************************************************************/
const SelectCall::ResultSetSettersTableWithOffset& SelectCall::TypesMap::getDefault()const{
	if(!ptrDefault)
		IAS_THROW(ItemNotFoundException("Default key - missing."));
	return *ptrDefault;
}
/*************************************************************************/
const SelectCall::ResultSetSettersTableWithOffset& SelectCall::TypesMap::lookup(const DM::DataObject* dm)const{
	IAS_TRACER;
...
/*************************************************************************/
void SelectCall::TypesMap::bind(::IAS::DS::API::IResultSetOutput* pResultSetOutput){
	IAS_TRACER;
...
/*************************************************************************/
void SelectCall::execute(::IAS::DM::DataObjectPtr& dm){
	IAS_TRACER;
