/*
 * File: IAS-QSystemLib/src/qs/workers/proc/ds/wrapper/SelectCall.h
 * 
 ...
 */
#ifndef _IAS_QS_Proc_Workers_DS_Wrapper_SelectCall_H_
#define _IAS_QS_Proc_Workers_DS_Wrapper_SelectCall_H_
...
/*************************************************************************/
/** The SelectCall class.
 *
 */
class SelectCall : public Select{
public:

	virtual ~SelectCall() throw();

	virtual void execute(::IAS::DM::DataObjectPtr& dm);

protected:
	SelectCall(::IAS::DS::API::Session* pSession,
		   Lexer *pLexer,
	...
	friend class Factory<SelectCall>;
};
...
#endif /* _IAS_QS_Proc_Workers_DS_Wrapper_SelectCall_H_ */
