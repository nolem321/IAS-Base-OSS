/*
 * File: IAS-QSystemLib/src/txm/Impl/Environment.h
 * 
 ...
 */
#ifndef _IAS_TXM_Impl_Environment_H_
#define _IAS_TXM_Impl_Environment_H_

#include <txm/api/Environment.h>
...
public:
	...
	virtual API::Connection* connect(const URI& uri);
...
protected:
	...
	typedef System* (*ExternalSystemFactoryPtr)(const URI& uri);
...
#endif /* _IAS_TXM_Impl_Environment_H_ */
