/*
 * File: IAS-QSystemMod-FCGI/src/qs/Impl/fcgi/Connection.h
 * 
 ...
 */
#ifndef _IAS_QS_FCGI_Connection_H_
#define _IAS_QS_FCGI_Connection_H_
...
public:
	...
	FCGI::System *getSystem();

protected:
	Connection(FCGI::System* pSystem, const String& strName);
...
#endif /* _IAS_QS_FCGI_Connection_H_ */
