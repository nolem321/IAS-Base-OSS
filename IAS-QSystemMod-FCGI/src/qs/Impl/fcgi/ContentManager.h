/*
 * File: IAS-QSystemMod-FCGI/src/qs/Impl/fcgi/ContentManager.h
 * 
 ...
 */
#ifndef _IAS_QS_FCGI_ContentManager_H_
#define _IAS_QS_FCGI_ContentManager_H_
...
#endif /* _IAS_QS_FCGI_ContentManager_H_ */
