/*
 * File: IAS-QSystemMod-FCGI/src/qs/Impl/fcgi/Message.h
 * 
 ...
 */
#ifndef _IAS_QS_FCGI_Message_H_
#define _IAS_QS_FCGI_Message_H_
...
public:
	...
	void write(FCGX_Stream* pFCGXStream);

protected:
	Message();
	Message(FCGX_Stream* pFCGXStream);
