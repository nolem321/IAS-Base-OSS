/*
 * File: IAS-QSystemMod-FCGI/src/qs/Impl/fcgi/Receiver.h
 * 
 ...
 */
#ifndef _IAS_QS_FCGI_Receiver_H_
#define _IAS_QS_FCGI_Receiver_H_
...
private:
	void parseCookies(const String& strValue, API::Attributes*pAttributes);

	static const String& CCookiePrefix;
...
#endif /* _IAS_QS_FCGI_Receiver_H_ */
