/*
 * File: IAS-QSystemMod-FCGI/src/qs/Impl/fcgi/SessionAutoCommit.h
 * 
 ...
 */
#ifndef _IAS_QS_FCGI_SessionAutoCommit_H_
#define _IAS_QS_FCGI_SessionAutoCommit_H_
...
#endif /* _IAS_QS_FCGI_SessionAutoCommit_H_ */
