/*
 * File: IAS-QSystemMod-FCGI/src/qs/Impl/fcgi/SessionTransacted.h
 * 
 ...
 */
#ifndef _IAS_QS_FCGI_SessionTransacted_H_
#define _IAS_QS_FCGI_SessionTransacted_H_
...
#endif /* _IAS_QS_FCGI_SessionTransacted_H_ */
