/*
 * File: IAS-QSystemMod-LMDB/src/ds/Impl/LMDB/Connection.cpp
 *
...
/*************************************************************************/
Connection::Connection(LMDB::System* pSystem,
...
API::Session* Connection::createSession(API::Session::TransactionMode iMode){
	...
	switch(iMode){
		...
		case API::Session::SM_Transacted:
			return IAS_DFT_FACTORY<LMDB::SessionTransacted>::Create(this);

		case API::Session::SM_NonTransacted:
			return IAS_DFT_FACTORY<LMDB::SessionAutoCommit>::Create(this);
...
/*************************************************************************/
LMDB::System* Connection::getSystem(){
	IAS_TRACER;
	return pSystem;
}
/*************************************************************************/
