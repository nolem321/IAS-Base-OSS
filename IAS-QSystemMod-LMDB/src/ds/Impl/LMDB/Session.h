/*
 * File: IAS-QSystemMod-LMDB/src/ds/Impl/LMDB/Session.h
 *
 ...
 */
#ifndef _IAS_DS_LMDB_Session_H_
#define _IAS_DS_LMDB_Session_H_
...
public:
  ...
  virtual API::StatementFunCall*  createFunCall();
	...
	inline MDB_txn *getTxn(){ return txn; }
	inline MDB_dbi  getDBi(){ return dbi; }
