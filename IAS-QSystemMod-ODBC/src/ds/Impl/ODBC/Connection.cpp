 ...
 *
 * File: IAS-QSystemMod-ODBC/src/ds/Impl/ODBC/Connection.cpp
 *
...
/*************************************************************************/
Connection::Connection(ODBC::System* pSystem,
...
API::Session* Connection::createSession(API::Session::TransactionMode iMode){
	...
	switch(iMode){
		...
		case API::Session::SM_Transacted:
			return IAS_DFT_FACTORY<ODBC::SessionTransacted>::Create(this);

		case API::Session::SM_NonTransacted:
			return IAS_DFT_FACTORY<ODBC::SessionAutoCommit>::Create(this);

		case API::Session::SM_XAManaged:
			return IAS_DFT_FACTORY<ODBC::SessionXAManaged>::Create(this);
...
/*************************************************************************/
ODBC::System* Connection::getSystem(){
	IAS_TRACER;
	return pSystem;
}
/*************************************************************************/
