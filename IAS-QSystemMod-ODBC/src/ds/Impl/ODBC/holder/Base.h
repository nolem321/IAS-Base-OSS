 ...
 *
 * File: IAS-QSystemMod-ODBC/src/ds/Impl/ODBC/holder/Base.h 
 *
 ...
 * 
 */
#ifndef _IAS_DS_Impl_ODBC_Holder_Base_H_
#define _IAS_DS_Impl_ODBC_Holder_Base_H_
...
#endif /* _IAS_DS_Impl_ODBC_Base_H_ */
