 ...
 *
 * File: IAS-QSystemMod-ODBC/src/ds/Impl/ODBC/holder/Text.h 
 *
 ...
 * 
 */
#ifndef _IAS_DS_Impl_ODBC_Holder_Text_H_
#define _IAS_DS_Impl_ODBC_Holder_Text_H_
...
#endif /* _IAS_DS_Impl_ODBC_Holder_Text_H_ */
