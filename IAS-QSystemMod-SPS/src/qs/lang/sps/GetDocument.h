/*
 * File: IAS-QSystemMod-SPS/src/qs/lang/sps/GetDocument.h
 *
 ...
 */
#ifndef _IAS_QS_Lang_SPS_GetDocument_H_
#define _IAS_QS_Lang_SPS_GetDocument_H_
...
/*************************************************************************/
/** The GetDocument class.
 *
 */
class GetDocument : public ::IAS::Lang::Interpreter::Extern::Statement {
public:

	virtual ~GetDocument() throw();
...
protected:
	...
	GetDocument(const DM::Type* pType, const StringList& lstParamaters, const ::IAS::Lang::Interpreter::Extern::ModuleProxy* pModuleProxy);
	...
	friend class ::IAS::Factory<GetDocument>;
};
...
#endif /* _IAS_Lang_Interpreter_Extern_Std_GetDocument_H_ */
