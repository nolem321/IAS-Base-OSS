/*
 * File: IAS-QSystemMod-SPS/src/qs/lang/sps/SetDocument.h
 *
 ...
 */
#ifndef _IAS_QS_Lang_SPS_SetDocument_H_
#define _IAS_QS_Lang_SPS_SetDocument_H_
...
/*************************************************************************/
/** The SetDocument class.
 *
 */
class SetDocument : public ::IAS::Lang::Interpreter::Extern::Statement {
public:

	virtual ~SetDocument() throw();
...
protected:
	...
	SetDocument(const DM::Type* pType, const StringList& lstParamaters, const ::IAS::Lang::Interpreter::Extern::ModuleProxy* pModuleProxy);
	...
	friend class ::IAS::Factory<SetDocument>;
};
...
#endif /* _IAS_Lang_Interpreter_Extern_Std_SetDocument_H_ */
