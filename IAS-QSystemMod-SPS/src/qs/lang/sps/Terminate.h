/*
 * File: IAS-QSystemMod-SPS/src/qs/lang/sps/Terminate.h
 *
 ...
 */
#ifndef _IAS_QS_Lang_SPS_Terminate_H_
#define _IAS_QS_Lang_SPS_Terminate_H_
 ...
 *
 */
class Terminate : public ::IAS::Lang::Interpreter::Extern::Statement {
public:
...
protected:
	...
	Terminate(const DM::Type* pType, const StringList& lstParamaters, const ::IAS::Lang::Interpreter::Extern::ModuleProxy* pModuleProxy);
	...
	friend class ::IAS::Factory<Terminate>;
};
...
#endif /* _IAS_Lang_Interpreter_Extern_Std_Terminate_H_ */
