/*
 * File: IAS-QSystemMod-SQLite/src/ds/Impl/SQLite/SessionAutoCommit.h
 * 
 ...
 */
#ifndef _IAS_DS_SQLite_SessionAutoCommit_H_
#define _IAS_DS_SQLite_SessionAutoCommit_H_
...
#endif /* _IAS_DS_SQLite_SessionAutoCommit_H_ */
