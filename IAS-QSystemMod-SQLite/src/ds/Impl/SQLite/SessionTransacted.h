/*
 * File: IAS-QSystemMod-SQLite/src/ds/Impl/SQLite/SessionTransacted.h
 * 
 ...
 */
#ifndef _IAS_DS_SQLite_SessionTransacted_H_
#define _IAS_DS_SQLite_SessionTransacted_H_
...
#endif /* _IAS_DS_SQLite_SessionTransacted_H_ */
