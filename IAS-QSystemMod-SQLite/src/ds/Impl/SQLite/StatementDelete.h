/*
 * File: IAS-QSystemMod-SQLite/src/ds/Impl/SQLite/StatementDelete.h
 * 
 ...
 */
#ifndef _IAS_DS_Impl_SQLite_StatementDelete_H_
#define _IAS_DS_Impl_SQLite_StatementDelete_H_
...
#endif /* _IAS_DS_Impl_SQLite_StatementDelete_H_ */
