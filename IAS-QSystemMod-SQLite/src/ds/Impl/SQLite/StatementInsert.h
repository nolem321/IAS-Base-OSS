/*
 * File: IAS-QSystemMod-SQLite/src/ds/Impl/SQLite/StatementInsert.h
 * 
 ...
 */
#ifndef _IAS_DS_Impl_SQLite_StatementInsert_H_
#define _IAS_DS_Impl_SQLite_StatementInsert_H_
...
#endif /* _IAS_DS_Impl_SQLite_StatementInsert_H_ */
