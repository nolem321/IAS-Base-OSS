/*
 * File: IAS-ServiceManagerExe/src/sm_dsp_service.cpp
 * 
...
#include "sm/cmdline/DisplayParameters.h"
...
int main(int argc, char* argv[]) {
	...
	try {
		...
		IAS_DFT_FACTORY<CmdLine::DisplayParameters>::PtrHolder ptrParameters(IAS_DFT_FACTORY<CmdLine::DisplayParameters>::Create(argc, argv));
