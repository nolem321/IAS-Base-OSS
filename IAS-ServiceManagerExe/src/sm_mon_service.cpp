/*
 * File: IAS-ServiceManagerExe/src/sm_mon_service.cpp
 * 
...
#include "sm/cmdline/MonitorParameters.h"
...
int main(int argc, char* argv[]) {
	...
	try {
		...
		IAS_DFT_FACTORY<CmdLine::MonitorParameters>::PtrHolder ptrParameters(IAS_DFT_FACTORY<CmdLine::MonitorParameters>::Create(argc, argv));
		...
		ptrServiceManager->watchServices(ptrParameters->getGrpAttrPairList());
