/*
 * File: IAS-ServiceManagerLib/src/sm/worker/WorkerForTxtDsp.h
 * 
 ...
 */
#ifndef _IAS_SM_Worker_WorkerForTxtDsp_H_
#define _IAS_SM_Worker_WorkerForTxtDsp_H_
...
/*************************************************************************/
/** The WorkerForTxtDsp class.
 *
 */
class WorkerForTxtDsp : public IWorker {
public:

	virtual ~WorkerForTxtDsp() throw();
...
#endif /* _IAS_SM_Worker_WorkerForTxtDsp_H_ */
